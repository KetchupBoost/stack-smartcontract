      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Lorem Ipsum</h2>
            <p className="text-xl text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aliquam iaculis ligula in hendrerit. In dictum lacus eget consequat scelerisque.</p>
          </div>
